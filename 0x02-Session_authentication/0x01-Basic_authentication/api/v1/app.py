...
# Create an instance of BasicAuth depending on the environment variable
auth = None
...
if auth_type == "basic_auth":
    ...
    # If no AUTH_TYPE is specified, fall back to a default (you can add your own Auth class here)
    pass  
